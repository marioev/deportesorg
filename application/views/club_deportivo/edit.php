			...
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="estado_club" value="<?php echo ($this->input->post('estado_club') ? $this->input->post('estado_club') : $club_deportivo['estado_club']); ?>" class="form-control" id="estado_club" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="direccion_club" class="control-label">Direccion Club</label>
						<div class="form-group">
							<textarea name="direccion_club" class="form-control" id="direccion_club"><?php echo ($this->input->post('direccion_club') ? $this->input->post('direccion_club') : $club_deportivo['direccion_club']); ?></textarea>
						</div>
					</div>
				</div>
			</div>
